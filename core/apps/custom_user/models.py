...
class User(BaseUser):
    ...
    def send_verification_code_email(self, code):
        send_mail(
            ...
            from_email='<notifications@zepto.yoursite.com>',
...
def password_reset_token_created(sender, instance, reset_password_token, *args, **kwargs):
    ...
    context = {
        ...
        'reset_password_url': f"https://yoursite.com/reset/confirm/?token={reset_password_token.key}&email={reset_password_token.user.email}"
    }
